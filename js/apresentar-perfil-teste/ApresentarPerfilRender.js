(function (window) {
    ...
    /* =========================================================
       ...
       - Renderizar identidade tanto no estado com mídia
         quanto no estado sem mídia.
       - Renderizar avaliação.
       - Renderizar gêneros/estilos.
       - Renderizar descrição.
       - Renderizar informações profissionais básicas.
    ...
    /* =========================================================
       ...
       O nome precisa aparecer em dois lugares:
    ...
    /* =========================================================
       ...
       Atualiza os dois avatares da página:
    ...
    function renderizar() {
        ...
        /*
         * Atualiza ícones Lucide caso algum elemento
         * da página utilize data-lucide.
         *
         * A renderização do perfil não depende do Lucide.
         */
        if (
            window.lucide &&
