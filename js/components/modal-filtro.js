...
/* =========================================================
   ...
   Responsabilidades:
   - Criar e controlar o modal de filtros.
   - Filtrar por estado e cidade.
   - Filtrar pelos tipos oficiais de artista.
   - Filtrar por instrumento.
   - Filtrar por estilo musical.
   - Filtrar por faixa de valor.
   - Enviar os filtros aplicados para o Feed.

   IMPORTANTE:
   - As categorias de artista utilizam exatamente os mesmos
     valores usados pelo cadastro e gravados no banco.
   - Não existem categorias intermediárias como "musicos",
     "cantores" ou "eventos".
   ========================================================= */
...
window.ModalFiltro = {
                ...
                >
                    ...
                    <div class="modal-filter-content">
                        ...
                        <!-- =================================================
                             ...
                             utilizados pelo cadastro e pelo banco.
                             ================================================= -->
    ...
    tratarMudancaCategoria() {
        ...
        /*
         * O campo Instrumento aparece somente para
         * Músico(a), exatamente como definido no cadastro.
         */

        const mostrar =
            categoria.value === "Músico(a)";
    ...
    obterFiltros() {
        ...
        return {
            ...
            /*
             * A categoria agora é enviada exatamente como
