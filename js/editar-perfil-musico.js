 ...
 * =====================================================
 *
 * Cada tipo possui sua própria página de edição.
 *
 * O perfil continua sendo o mesmo.
 * Apenas o tipo_artista é alterado.
 */
...
/*
 * Converte nomes antigos ou variações para os nomes oficiais.
 *
 * Isso evita que:
 *
 * Músico
 * Músico(a)
 *
 * sejam considerados tipos diferentes.
 */
...
async function salvarSobre() {
    ...
    try {
        ...
        const dadosArtista = {
            ...
            /*
             * Se o usuário não mudou o tipo,
             * preservamos exatamente o valor existente.
             *
             * Se mudou, salvamos o nome oficial.
             */
        ...
        /*
         * Se o tipo mudou, vai para a página
         * específica do novo tipo.
         *
         * O perfil continua sendo o mesmo.
         */
