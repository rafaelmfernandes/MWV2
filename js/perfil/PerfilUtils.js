...
* ============================================================
*
* Chips comuns são controlados pelo PerfilUtils.
*
* Chips que pertencem a módulos específicos e possuem:
*
* 
  data-chip-module="true"
  
*
* ficam sob responsabilidade exclusiva do respectivo módulo.
*
* Isso evita que dois listeners sejam registrados no mesmo chip.
  */
...
document
    ...
    .forEach(container => {
        ...
        /*
         * Se este conjunto de chips pertence a um módulo
         * específico, o PerfilUtils não registra eventos nele.
         */
        ...
        container
            ...
            .forEach(chip => {
                 ...
                 * caso inicializarChips() seja chamado novamente.
                 */

                if (
                    chip.dataset.perfilUtilsInicializado === "true"
                ) {
                ...
                chip.dataset.perfilUtilsInicializado =
                    "true";
...
/*
 * Corrige a aplicação da classe de erro.
 */
