 ...
 * ============================================================
 *
 * Descobre automaticamente qual editor está aberto
 * e qual página de perfil deve ser usada como destino.
 *
 * Isso evita que o editor de músico, banda, DJ etc.
 * seja enviado para o perfil de cantor.
 */

const PAGINAS_EDITOR = {
    "editar-perfil-cantor.html": "meu-perfil-cantor.html",

    "editar-perfil-cantor-v2.html": "meu-perfil-cantor.html",

    "editar-perfil-musico.html": "meu-perfil-musico.html",

    "editar-perfil-banda.html": "meu-perfil-banda.html",

    "editar-perfil-dupla.html": "meu-perfil-dupla.html",

    "editar-perfil-dj.html": "meu-perfil-dj.html",

    "editar-perfil-dancarino.html": "meu-perfil-dancarino.html",

    "editar-perfil-grupo-danca.html": "meu-perfil-grupo-danca.html",

    "editar-perfil-mc.html": "meu-perfil-mc.html",

    "editar-perfil-compositor.html": "meu-perfil-compositor.html",

    "editar-perfil-produtor-musical.html": "meu-perfil-produtor-musical.html"
};
...
async function carregarDados() {
    ...
    try {
         ...
         * ----------------------------------------------------
         *
         * O redirecionamento continua sendo controlado
         * pelo tipo artístico, mas agora a página atual
...
function preencherFormulario() {
    ...
    if (
        ...
        if (
            CONFIG.paginaAtual === "editar-perfil-musico.html"
        ) {
            window.PerfilUtils.marcarChips(
                "instrumentos",
